...
public class SignIn {
	...
	private void initialize() {
		...
		cbServer.setModel(new DefaultComboBoxModel(new String[] {"North America", "Eu West", "Eu Nordic & East", "Latin America North", "Latin America South", "Brazil", "Turkey", "Russia", "Oceania"}));
		...
		cbRole.setModel(new DefaultComboBoxModel(new String[] {"Event Member", "Technical Member", "Media Member", "Partners & Management Member", "Trainer"}));
